...
sh bin/oxygen/scripts/validateCheckDITA.sh -i /gear-pump.ditamap -s scripts/validate-check-completeness/validate-check-completeness-options.xml -r bin/tmp-vcc/vcc-result.xml
