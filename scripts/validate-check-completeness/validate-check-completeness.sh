...
sh bin/oxygen/scripts/validateCheckDITA.sh -i ${pd}/dita_sources/gear-pump.ditamap -s ${pd}/scripts/validate-check-completeness/validate-check-completeness-options.xml -r bin/tmp-vcc/vcc-result.xml
